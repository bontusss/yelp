...
var createListing = (0, catchAsync_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, listing_1.default.create(req.body)];
            case 1:
                newListing = _a.sent();
                res.status(201).json({
                    status: 'success',
                    data: { newListing: newListing },
                });
                return [2 /*return*/];
        }
    });
...
var updateListing = (0, catchAsync_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, listing;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
